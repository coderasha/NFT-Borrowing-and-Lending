...
const { getBigNumber, NFT_TYPE, STATUS, TENOR_UNIT, GRACE_PERIOD } = require('../scripts/shared/utilities');
...
describe('TribeOne', function () {
  ...
  beforeEach(async function () {
    ...
    this.collateralCurrency = await this.MockERC20.deploy('MockUSDC', 'MockUSDC'); // will be used for collateral
    ...
    // addding loan currency to Asset
